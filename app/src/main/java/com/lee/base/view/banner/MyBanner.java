...
public class MyBanner extends RelativeLayout {
    ...
    List<MyBannerModel> list;
    MyBanner_Adapter adapter;
    ...
    private void initView() {
        ...
        adapter = new MyBanner_Adapter(context);
     ...
     * @param list
     */
    public void initPageIndex(List<MyBannerModel> list) {
        this.list = list;
        radio_button.removeAllViews();
        for (int i = 0; i < list.size(); i++) {
            RadioButton radioButton = new RadioButton(context);
            radioButton.setButtonDrawable(android.R.color.transparent);
            RadioGroup.LayoutParams radioParams = new RadioGroup.LayoutParams(30, 30);
            radioParams.leftMargin=20;
