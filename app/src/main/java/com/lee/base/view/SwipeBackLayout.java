...
public class SwipeBackLayout extends FrameLayout {
    ...
    private boolean enableMoveClose = false;
    ...
    public void setEnableMoveClose(boolean enableMoveClose) {
        this.enableMoveClose = enableMoveClose;
    }
    ...
    private void init() {
        mViewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
            ...
            public boolean tryCaptureView(View child, int pointerId) {
                return enableMoveClose&&child == mContentView;//如果child==mContentView，返回true，也就是说mContentView可以移动
            }
